...
import 'package:flutter_bird/models/chat/event_message.dart';
import 'package:flutter_bird/models/chat/global_message.dart';
import 'package:flutter_bird/models/chat/message.dart';
import 'package:flutter_bird/models/chat/personal_message.dart';
import 'package:flutter_bird/models/friend.dart';
import 'package:flutter_bird/models/user.dart';
import 'package:flutter_bird/services/rest/auth_service_social.dart';
import 'package:flutter_bird/services/settings.dart';
import 'package:flutter_bird/util/util.dart';
import 'package:flutter_bird/views/user_interface/chat_box/chat_box_change_notifier.dart';
import 'package:flutter_bird/views/user_interface/chat_window/chat_window_change_notifier.dart';
...
class ChatMessages extends ChangeNotifier {
  ...
  // We make a distinction between "World", "Events" and "Personal" for friends
  ...
  initializeChatMessages() {
    ...
    String message = "Welcome to the FlutterBird chat!";
  ...
  login() {
    ...
    initializeChatMessages();
    retrieveGlobalMessages();
    // populate chatData with friends?
    initializeChatRegions();
  }
